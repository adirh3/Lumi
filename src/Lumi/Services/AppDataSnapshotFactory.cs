    ...
    public static AppData CreateIndexSnapshot(AppData source)
    {
        ...
        return new AppData
        {
            Settings = new UserSettings
            {
                ...
                ExpandReasoningWhileStreaming = settings.ExpandReasoningWhileStreaming,
                PreferredModel = settings.PreferredModel,
                ReasoningEffort = settings.ReasoningEffort,
                IsByokEnabled = settings.IsByokEnabled,
                ByokProviderType = settings.ByokProviderType,
                ByokBaseUrl = settings.ByokBaseUrl,
                ByokModelId = settings.ByokModelId,
                ByokWireApi = settings.ByokWireApi,
                ByokAzureApiVersion = settings.ByokAzureApiVersion,
