    ...
    internal static LumiAgent CreateReleaseManagerAgent()
    {
        return new LumiAgent
        {
            ...
            SystemPrompt = """
                ...
                Your job is to reduce release-request toil while keeping safety decisions explicit. Stay chat-native: use normal Lumi chats, MCPs, projects, skills, and background jobs. Do not create a separate dashboard, shift view, hotkey flow, updater, or standalone release shell.
