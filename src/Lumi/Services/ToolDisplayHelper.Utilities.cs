...
public static partial class ToolDisplayHelper
{
    ...
    public static string FormatToolStatusName(string toolName, string? argsJson = null)
    {
        ...
        return toolName switch
        {
            ...
            "browser" or "lumi_browser_open" => Loc.Tool_OpeningPage,
            "browser_look" or "lumi_browser_look" => Loc.Tool_BrowserSnapshot,
            "browser_find" or "lumi_browser_find" => Loc.Tool_SearchingWeb,
            "browser_do" or "lumi_browser_do" => Loc.Tool_Action,
            "browser_js" or "lumi_browser_js" => Loc.Tool_BrowserEvaluate,
