...
public sealed class LumiMcpTools
{
    ...
    public Task<string> ConfigureFeature(
        ...
        [Description("For chat-event jobs, the source chat id/title to observe.")] string? sourceChatIdentifier = null,
        [Description("For chat-event jobs, event filters: turn_start, turn_end, idle, error, aborted, or *.")] string[]? chatEventTypes = null,
        [Description("Background job trigger type: time, script, or chat_event.")] string? triggerType = null,
        ...
        [Description("Settings: show Lumi's ambient presence glow.")] bool? showAmbientPresence = null,
        [Description("Settings: continuously animate presence while Lumi is working.")] bool? animatePresenceWhileWorking = null,
        ...
        [Description("Optional Lumi app/debug bridge process id to target.")] int? targetProcessId = null)
    {
        var arguments = Args(
            ...
            ("sourceChatIdentifier", sourceChatIdentifier),
            ("chatEventTypes", chatEventTypes),
